...
int main()
{
    ...
    for (int timeframe = 0; timeframe < 10; timeframe++)
    {
        ...
        vector<vector<double>> data_rate_embb_copy(8, vector<double>(no_of_embb_users));
        for (int i = 0; i < 8; i++)
            data_rate_embb_copy[i] = data_rate_embb;
        ...
        for (int minislots = 0; minislots < 8; minislots++)
        {
            ...
            for (int i = 0; i < no_of_embb_users; i++)
            {
                channel_rb_embb_copy[i].second += prev_loss_sum[i] / 8.0;
            }
            ...
            for (int i = 0; i < channel_rb_embb.size(); i++)
            {
                ...
                curr_loss_sum[i] += abs(channel_rb_embb_standard[i].second - channel_rb_embb_copy[i].second);
            }
            cout << endl;
            for (int i = 0; i < no_of_embb_users; i++)
            {
        ...
        for (int i = 0; i < no_of_embb_users; i++)
        {
            prev_loss_sum[i] = curr_loss_sum[i];
        }
